...
func (application *Application) GetCustomerInvoicesService(customerId types.EID, queryParams *types.GetQueryParams, isPaid bool) (*dto.GetCustomerInvoicesDTO, error) {
	...
	customerInvoicesDTO, err := application.invoiceRepository.GetByCustomerID(customerId, queryParams, isPaid)
	...
	utils.Logger.Info(fmt.Sprintf("[GetCustomerInvoicesService] getCustomerInvoicesDTO: %v", *customerInvoicesDTO))

	return customerInvoicesDTO, nil
